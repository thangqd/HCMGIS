...
class Ui_hcmgis_opendata_form(object):
    def setupUi(self, hcmgis_opendata_form):
        ...
        self.gridLayout.addWidget(self.BtnOutputFolder, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.LinOutputFolder, 7, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.ChkSaveShapefile, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.LblStatus, 9, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.LblFormat, 8, 0, 1, 2)
        ...
        self.CboFormat.addItem("")
        self.CboFormat.addItem("")
        self.gridLayout.addWidget(self.CboFormat, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.TblWFSLayers, 5, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.status, 10, 0, 1, 3)
